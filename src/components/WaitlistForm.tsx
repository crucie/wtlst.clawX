  ...
  const generateTweet = async (agentNumber?: number, totalCount?: number) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        const fallbackText = `I've just secured early access ${displayNum ? `as Agent ${displayNum} ` : ""}to @ClawXLabs — the native Agentic Prediction Market on Avalanche (🔺). waitlist.clawxlab.xyz?v=2 @ClawXLabs @AvalancheFDN`;
